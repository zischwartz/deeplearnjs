...
export declare type DType = 'float32' | 'int32' | 'bool';
export declare const NAN_INT32: number;
export declare const NAN_BOOL = 255;
export declare const NAN_FLOAT32: number;
export declare function getNaN(dtype: DType): number;
export declare function isValNaN(val: number, dtype: DType): boolean;
