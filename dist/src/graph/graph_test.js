...
describe('Graph', function () {
    ...
    it('variable creates a node in the graph', function () {
        var v = g.variable('', ndarray_1.NDArray.zeros([1]));
    ...
    it('variable passes name to graph node', function () {
        var v = g.variable('hello', ndarray_1.NDArray.zeros([1]));
    ...
    it('mnist fully-connected', function () {
        ...
        var fd = new session_1.FeedDictionary([{ tensor: input, data: ndarray_1.NDArray.zeros([1]) }]);
...
describe('Variable validation', function () {
    ...
    it('non null data does not throw', function () {
        g.variable('test', ndarray_1.NDArray.zeros([5]));
    });
});
...
describe('Constant', function () {
    ...
    it('non null data does not throw', function () {
        expect(g.constant(ndarray_1.NDArray.zeros([5])).shape).toEqual([5]);
    });
    it('from a single value', function () {
        var c = g.constant(3);
        expect(c.shape).toEqual([]);
        var values = c.node.data.getValues();
