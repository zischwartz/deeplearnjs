...
export declare class NDArrayMathGPU extends NDArrayMath {
    ...
    protected cloneInternal<G extends keyof DataTypes, T extends NDArray<G>>(a: T): T;
    ...
    protected minInternal<G extends keyof DataTypes>(a: NDArray<G>, axes: number[]): NDArray<G>;
    protected maxInternal<G extends keyof DataTypes>(a: NDArray<G>, axes: number[]): NDArray<G>;
    ...
    protected multinomialInternal(probs: Array2D, numSamples: number, seed: number): Array2D<'int32'>;
