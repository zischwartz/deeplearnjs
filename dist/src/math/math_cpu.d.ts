...
export declare class NDArrayMathCPU extends NDArrayMath {
    ...
    protected sumInternal<T extends keyof DataTypes>(input: NDArray<T>, axes: number[]): NDArray<SumTypes[T]>;
    ...
    protected minInternal<G extends keyof DataTypes>(input: NDArray<G>, axes: number[]): NDArray<G>;
    protected maxInternal<G extends keyof DataTypes>(input: NDArray<G>, axes: number[]): NDArray<G>;
    ...
    protected leakyReluInternal<T extends NDArray>(ndarray: T, alpha: number): T;
    protected clipInternal<T extends NDArray>(ndarray: T, min: number, max: number): T;
    ...
    protected multinomialInternal(probabilities: Array2D, numSamples: number, seed: number): Array2D<'int32'>;
