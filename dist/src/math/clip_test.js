...
var ndarray_1 = require("./ndarray");
{
    var tests = function (it) {
        it('basic', function (math) {
            ...
            test_util.expectArraysClose(result.getValues(), new Float32Array([3, -1, 0, 50, -1, 2]));
            a.dispose();
        });
        it('propagates NaNs', function (math) {
            ...
            var max = 50;
            var result = math.clip(a, min, max);
            test_util.expectArraysClose(result.getValues(), new Float32Array([3, -1, 0, 50, -1, 2, NaN]));
            a.dispose();
        });
