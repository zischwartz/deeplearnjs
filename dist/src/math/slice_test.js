...
var ndarray_1 = require("./ndarray");
{
    var tests = function (it) {
        ...
        it('slices 5x1 into shape 3x1 starting at 1', function (math) {
            ...
            test_util.expectArraysClose(result.getValues(), new Float32Array([2, 3, 4]));
            a.dispose();
        });
    };
...
}
{
    var tests = function (it) {
        ...
        it('returns a ndarray of slice size', function (math) {
            var a = ndarray_1.Array2D.zeros([100, 100]);
        ...
        it('returns the upper-left submatrix when begin is [0, 0]', function (math) {
            var a = ndarray_1.Array2D.randUniform([10, 10], -1, 1);
            var b = math.slice2D(a, [0, 0], [2, 2]);
            var aValues = a.getValues();
            var expected = new Float32Array([aValues[0], aValues[1], aValues[10], aValues[11]]);
        ...
        it('returns the rectangle specified', function (math) {
            ...
            var expected = new Float32Array([5, 6, 8, 9, 11, 12]);
            test_util.expectArraysClose(b.getValues(), expected);
            a.dispose();
        });
...
}
{
    var tests = function (it) {
        ...
        it('slices 2x2x2 array into 1x2x2 starting at [1, 0, 0]', function (math) {
            ...
            test_util.expectArraysClose(result.getValues(), new Float32Array([5, 6, 7, 8]));
            a.dispose();
        });
...
}
{
    var tests = function (it) {
        ...
        it('slices 2x2x2x2 array into 1x2x2x2 starting at [1, 0, 0, 0]', function (math) {
            ...
            test_util.expectArraysClose(result.getValues(), new Float32Array([11, 22, 33, 44, 55, 66, 77, 88]));
            a.dispose();
        });
