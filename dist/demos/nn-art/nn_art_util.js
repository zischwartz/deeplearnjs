...
function addLatentVariables(gpgpu, addZShader, sourceTex, resultTex, shapeRowCol, z1, z2) {
    ...
    var sourceSamplerLocation = deeplearn_1.webgl_util.getProgramUniformLocationOrThrow(gpgpu.gl, addZShader, 'source');
    gpgpu.setInputMatrixTexture(sourceTex, sourceSamplerLocation, 0);
    var zLoc = gpgpu.getUniformLocation(addZShader, 'z');
...
function render(gpgpu, renderShader, sourceTex, outputNumDimensions, colorMode) {
    ...
    var sourceSamplerLocation = deeplearn_1.webgl_util.getProgramUniformLocationOrThrow(gpgpu.gl, renderShader, 'source');
    gpgpu.setInputMatrixTexture(sourceTex, sourceSamplerLocation, 0);
    var colorModeLoc = gpgpu.getUniformLocation(renderShader, 'colorMode');
    gpgpu.gl.uniform1i(colorModeLoc, colorMode);
    var outputNumDimensionsLoc = gpgpu.getUniformLocation(renderShader, 'outputNumDimensions');
...
//# sourceMappingURL=nn_art_util.js.map