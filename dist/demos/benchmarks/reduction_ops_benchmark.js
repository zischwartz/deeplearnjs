...
var ReductionOpsBenchmark = (function (_super) {
    __extends(ReductionOpsBenchmark, _super);
    function ReductionOpsBenchmark() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ReductionOpsBenchmark.prototype.getReductionOp = function (option, math) {
        switch (option) {
            case 'max':
                return function (input) { return math.max(input); };
            case 'min':
                return function (input) { return math.min(input); };
            case 'sum':
                return function (input) { return math.sum(input); };
            case 'logSumExp':
                return function (input) { return math.logSumExp(input); };
            default:
                throw new Error("Not found such ops: " + option);
        }
    };
    return ReductionOpsBenchmark;
}(benchmark_1.BenchmarkTest));
exports.ReductionOpsBenchmark = ReductionOpsBenchmark;
var ReductionOpsCPUBenchmark = (function (_super) {
    __extends(ReductionOpsCPUBenchmark, _super);
    ...
    ReductionOpsCPUBenchmark.prototype.run = function (size, option) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                op = this.getReductionOp(option, math);
...
}(ReductionOpsBenchmark));
exports.ReductionOpsCPUBenchmark = ReductionOpsCPUBenchmark;
var ReductionOpsGPUBenchmark = (function (_super) {
    __extends(ReductionOpsGPUBenchmark, _super);
...
//# sourceMappingURL=reduction_ops_benchmark.js.map