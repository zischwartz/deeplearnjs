...
var SqueezeNet = (function () {
    ...
    SqueezeNet.prototype.loadVariables = function () {
        ...
        return new Promise(function (resolve, reject) {
            var checkpointLoader = new deeplearn_1.CheckpointLoader(GOOGLE_CLOUD_STORAGE_DIR + 'squeezenet1_1/');
    ...
    SqueezeNet.prototype.infer = function (input) {
        var _this = this;
        ...
        var layerNames = Object.keys(namedActivations);
